...
async def load_data_llama(  # To handle the reset flag
    ...
    # Initialize the index and process documents
    index = initialize_index()  # Assuming initialize_index handles the reset_db flag
